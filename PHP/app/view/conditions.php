    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="texte_a_afficher" class="texte_inselectionnable">
                ...
                <p style="text-align: center;"><strong>CONDITIONS GÉNÉRALES D'UTILISATION</strong> <strong>ET DE VENTE </strong><strong>DU SITE</strong></p>
                <p style="text-align: center;"><strong><span id="span_id_nom_site">PhoneDeals</span></strong></p>

                <p><strong></strong></p>
                <p><strong><br>I. CONDITIONS GÉNÉRALES D'UTILISATION</strong></p>
                ...
                <p>Le site <span id="span_id_nom_site">PhoneDeals</span> est édité par :</p>

                <p><span id="span_id_nom_editeur">Hadrien Rannou</span>, dont le siège siège social est situé à l'adresse suivante : <span id="span_id_adresse_siege_social_editeur">120 rue de l'exode</span>, et immatriculée au <span id="span_id_immatriculation_editeur">0123456789</span>.</p>
                <p>Téléphone : <span id="span_id_n_de_telephone_de_la_societe">0233771168</span>/ Adresse e-mail : <span id="span_id_adresse_mail_editeur">phonedeals@gmail.com</span>.</p>
                <p><br>Le directeur de publication du site est :</p>
                <p><span id="span_id_civilite_et_nom_du_directeur_de_publication">Aymeric Picot</span>.</p>
                <p><br>Le site <span id="span_id_nom_site">PhoneDeals</span> est hébergé par :</p>
                <p><span id="span_id_denomination_sociale_de_l_hebergeur">Tomcat</span>, dont le siège est situé <span id="span_id_siege_social_de_l_hebergeur">120 rue de l'exode, 50000 Saint-Lô</span></p>
                <p>Numéro de téléphone : <span id="span_id_telephone_de_l_hebergeur">0233771168</span></p>
                <p><strong><br>ARTICLE 2. PRÉSENTATION DU SITE</strong></p>
                <p>Le site <span id="span_id_nom_site">PhoneDeals</span> a pour objet :</p>
                <p><span id="span_id_description_personnalisee_du_site">Phonedeals est un site de vente de téléphone.</span></p>
                <p><strong><br>ARTICLE 3. CONTACT</strong></p>
                <p>Pour toute question ou demande d'information concernant le site, ou tout signalement de contenu ou d'activités illicites, l'utilisateur peut contacter l'éditeur à l'adresse e-mail suivante: <span id="span_id_adresse_e_mail_de_contact_pour_le_dp">phonedeals@gmail.com</span> ou adresser un courrier recommandé avec accusé de réception à : <span id="span_id_nom_editeur">Hadrien Rannou</span> - <span id="span_id_adresse_siege_social_editeur">120 rue de l'exode</span></p>
                ...
                <p>La connexion et la navigation sur le site <span id="span_id_nom_site">PhoneDeals</span> valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.</p>
                ...
                <p>Toute communication réalisée par <span id="span_id_nom_site">PhoneDeals</span> et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l'utilisateur. Ce dernier s'engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.</p>
                ...
                <p><span id="span_id_nom_site">PhoneDeals</span> se réserve en tout état de cause la possibilité de refuser une demande d'inscription aux services en cas de non-respect par l'Utilisateur des dispositions des présentes Conditions Générales d'Utilisation.</p>
                ...
                <p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels <span id="span_id_nom_site">PhoneDeals</span> n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.</p>
                ...
                <p>Enfin, <span id="span_id_nom_site">PhoneDeals</span> se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale.</p>
                ...
                <p style="text-align: center;"><em><br>Le site <span id="span_id_nom_site">PhoneDeals</span> vous souhaite une excellente navigation !</em></p>
                <p><br><br><br><strong>II. CONDITIONS GÉNÉRALES DE VENTE</strong></p>
                <p><strong><br>PREAMBULE</strong></p>
                <p>Le site est édité par le vendeur, <span id="span_id_nom_editeur">Hadrien Rannou</span>, dont le siège social est situé à l'adresse suivante : <span id="span_id_adresse_siege_social_editeur">120 rue de l'exode</span>, et immatriculée au <span id="span_id_immatriculation_editeur">0123456789</span>.</p>
                <p>Numéro individuel d'identification intracommunautaire du vendeur : <span id="span_id_numero_identification_tva">0123456789</span></p>

                <p>L'activité du vendeur est soumise au régime réglementé suivant : <br><span id="span_id_precision_regime_d_autorisation_ou_reglementation">Vente de téléphone mobile.</span></p>
                <p>Les dispositions suivantes ont pour objet de définir les conditions générales de vente sur le site <span id="span_id_nom_site">PhoneDeals</span></p>
                ...
                <p><br><strong>ARTICLE 1. CATALOGUE OU BOUTIQUE EN LIGNE</strong></p>
                ...
                <p><br><strong>ARTICLE 2. PRIX</strong></p>
                ...
                <p><br><strong>ARTICLE 3. COMMANDE EN LIGNE</strong></p>
                ...
                <p><br><strong>ARTICLE 4. CONFIRMATION ET PAIEMENT DE LA COMMANDE</strong></p>
                ...
                <p><span id="span_id_modalites_de_reclamation_cb">Par téléphone du lundi au vendredi, de 9h à 20 au numéro suivant : 0233771178;<br>par email : phonedeals@gmail.com;<br>par courrier : PhoneDeals, 120 rue de l'exode, 50000 Saint-Lô</span></p>
                ...
                <p><span id="span_id_coordonnees_du_service_client">Par téléphone du lundi au vendredi, de 9h à 20 au numéro suivant : 0233771178;<br>par email : phonedeals@gmail.com;<br>par courrier : PhoneDeals, 120 rue de l'exode, 50000 Saint-Lô</span></p>
                <p><br><strong>ARTICLE 5. SIGNATURE ÉLECTRONIQUE</strong></p>
                ...
                <p><br><strong>ARTICLE 6. PREUVE DE LA TRANSACTION</strong></p>
                ...
                <p><br><strong>ARTICLE 7. MODE DE PAIEMENT</strong></p>
                ...
                <p><br><strong>ARTICLE 8. LIVRAISON</strong></p>
                ...
                <p><span id="span_id_delai_de_livraison">livraison standard : de 3 à 5 jours.<br>livraison express : 3 jours<br>liraison premium : dès le lendemain (si la commande a été faite avant 15h).</span></p>
                ...
                <p><span id="span_id_modalites_de_retour_du_produit">Les produits doivent être retourné sous 30 jours et en bon état.</span></p>
                ...
                <p><br><strong>ARTICLE 9. GARANTIES DES PRODUITS</strong></p>
                ...
                <p>9.3 GARANTIE COMMERCIALE</p>
                <p>Le vendeur offre au client une garantie commerciale couvrant la conformité des produits et assurant en cas de non-conformité le remboursement du prix d'achat, le remplacement ou la réparation du produit, pendant la durée suivante : <span id="span_id_duree_de_la_garantie_commerciale">1 an</span>.</p>
                <p>Cette garantie ne couvre pas les défauts occasionnés du fait d'une utilisation anormale ou fautive ou résultant d'une cause étrangère aux qualités intrinsèques des produits.</p>
                <p>Cette garantie n'est pas exclusive de l'application des garanties prévues aux 9.1 et 9.2.</p>
                <p><br><strong>ARTICLE 10. INDISPONIBILITÉ DES PRODUITS ET REMBOURSEMENT</strong></p>
                <p>En cas d'indisponibilité d'un produit commandé, le client en sera informé par courrier électronique.</p>
                <p>Le client aura la possibilité d'annuler sa commande et aura ainsi le choix entre le remboursement des sommes par lui versées dans les 30 jours au plus tard de leur versement, ou à l'échange du produit.<br><br></p>
                ...
                <p>Le client fera valoir son droit de rétractation en contactant le service client :<br><span id="span_id_coordonnees_du_service_client">Par téléphone du lundi au vendredi, de 9h à 20 au numéro suivant : 0233771178;<br>par email : phonedeals@gmail.com;<br>par courrier : PhoneDeals, 120 rue de l'exode, 50000 Saint-Lô</span></p>
                ...
                <p>Le client pourra demander l'échange ou le remboursement du produit retourné, sans pénalité, les frais de retour étant pris en charge par le vendeur. Néanmoins, en cas d'échange, des frais de livraison peuvent être à nouveau facturés au client.</p>
                ...
                <p>- tout produit sur-mesure<br>- tout produit ne pouvant pas par nature être réexpédié<br>- tout produit périssable<br>- tout produit vidéo<br>- tout produit de presse<br>- etc.</p>
                ...
                <p><br><strong>ARTICLE 12. PROTECTION DES DONNÉES</strong></p>
                ...
                <p>Le vendeur a fait à cet effet une déclaration à la CNIL sous le numéro <span id="span_id_numero_de_declaration_a_la_cnil">0123456789</span> </p>
                ...
                <p><span style="white-space:pre-wrap;"><span id="span_id_modalites_de_reclamation_donnees_personnelles" class="encours">Par téléphone du lundi au vendredi, de 9h à 20 au numéro suivant : 0233771178;<br>par email : phonedeals@gmail.com;<br>par courrier : PhoneDeals, 120 rue de l'exode, 50000 Saint-Lô</span></span>.</p>
                <p><br><strong>ARTICLE 13. FORCE MAJEURE</strong></p>
                ...
                <p><br><strong>ARTICLE 14. NULLITÉ PARTIELLE</strong></p>
                ...
                <p><br><strong>ARTICLE 15. LOI APPLICABLE ET JURIDICTION COMPÉTENTE</strong></p>
