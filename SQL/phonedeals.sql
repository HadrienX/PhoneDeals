...
(14, 'LG L Bello II', 1, '16', 109.99, '1,2', 'Héritée du design du G3, les touches de contrôle\r\nsituées sur la coque arrière font leur apparition sur le L Bello. Esthétiques et pratiques, elles remplacent les boutons sur le côté et s''avèrent bien plus pratique à utiliser au quotidien.'),
(15, 'LG G3S', 1, '16,32', 169.99, '1,2', 'Le nouveau LG G3 au design sobre, est\r\ntout simplement révolutionnaire, grâce à son grand écran QuadHD, un appareil photo de 13 Mégapixels et un processeur de 2,46GHz. Incarnant l''association parfaite de beauté et performance, il constitue le choix de l''excellence by LG.'),
(16, 'LG G4 Stylus', 1, '16,32,64,128', 184, '1,2,11', 'Le smartphone LG G4 Stylus est un\r\ntéléphone pratique à utiliser au quotidien grâce à son écran géant 5,7 pouces, son stylet, sa connectivité 4G, ses appareils photos performants...'),
(17, 'LG Spirit', 1, '16,32', 129, '1,2,11', 'Disposant d''un écran tactile HD de 4.7",\r\nle LG C70 Spirit est propulsé par un processeur Qualcomm Snapdragon 410 Quad-Core cadencé à 1.2 GHz et Android 5.0 Lollipop. Le smartphone LG Spirit vous garantit une expérience riche, en photo, vidéo, musique ou même en jeu. Le LG C70 Spirit est un passeport à prix réduit vers l''expérience multimédia mobile.'),
(18, 'LG Leon Y50', 1, '16,32', 115.5, '1,2,11', 'Le LG LEON 4G est un smartphone\r\nultra rapide et performant grâce à ses 4 coeurs ! Une fluidité optimale pour jouer et surfer sans limite ! Avec ses 1,09 cm d’épaisseur et son grand écran 4,5’’, le LG LEON 4G vous dévoile un design sophistiqué aux détails soignés.'),
(19, 'LG F60', 1, '16,32', 121, '1,2', 'LG F60 | ECRAN 4,5" (11,4CM) 800X480 | PROCESSEUR QUAD CORE 1,2 GHZ | BATTERIE 2100 MAH | APN 5MP | ANDROID 4.4.2 KITKAT | KNOCK CODE | 4G'),
(20, 'LG G2 Mini', 1, '16,32', 179, '1,2,9', 'Avec son design élégant et ses bords extrêmement fins et sans bouton, vous bénéficierez d''un grand écran dans un format mini.'),
(21, 'LG GFlex 2', 1, '16,32,64,128', 288, '1', ' Avec Android 5.0 Lollipop, votre téléphone LG montrera tout son potentiel : Mode Invité, mode « ne pas déranger », un accès rapide aux dernières applications et tous les avantages de ce tout dernier système d’exploitation.'),
(22, 'LG L Bello II', 1, '16,32', 114.99, '1,9,12', 'Son large écran 5" vous permet une navigation plus intuitive et un affichage plus clair des applications.\r\nIl mettra en valeur toutes vos photos et vidéos.'),
(23, 'LG Nexus 5x', 1, '16,32', 350.19, '1', 'Fonctionne avec tous les opérateurs. Système : Android 6.0 Marshmallow Processeur : Hexa-core / 1,8 GHz / Qualcomm Snapdragon 808 / Processeur graphique (GPU) : Adreno 418 Mémoires :\r\nInterne : 32 Go / RAM : 2 GoAffichage : 5,2 pouces / LCD / Rés');
