...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 02 Mars 2016 à 10:47
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  PRIMARY KEY (`id`),
  KEY `member` (`member`,`phones`(255)),
  KEY `member_2` (`member`),
  KEY `phone` (`phones`(255))
...
ALTER TABLE `order_product`
  ADD CONSTRAINT `order_product_ibfk_1` FOREIGN KEY (`phone`) REFERENCES `phone` (`id`);
