...
(27, 'Iphone 6', 5, '16,32,64,128', 576, '11,12', 'Plus grand que grand !'),
(28, 'Iphone 5S', 5, '16,32,64', 294.2, '11,12', 'A la pointe de la technologie, l''iPhone 5s intègre la puce A7 à l''architecture 64 bits, le capteur d''identité par empreinte digitale Touch ID, un nouvel appareil photo iSight de 8 Mégapixels, une nouvelle caméra FaceTime HD, une connectivité 4G LTE ultra-rapide, iOS 7 et iCloud. Il n''en reste pas moins tout aussi fin et léger.'),
...
(30, 'Iphone 5', 5, '16,32,64', 189, '1,2', 'On a peine à croire qu’un iPhone aussi suréquipé – un écran plus grand, une puce plus rapide, une technologie sans fil ultra-rapide, un appareil photo iSight 8 mégapixels – puisse être aussi fin et léger. C’est pourtant vrai. L’iPhone 5 est le plus fin et le plus léger iPhone de tous les temps.'),
(21, 'Iphone 4S', 5, '16,32,64', 119, '1,2', 'Des nouveautés pour un iPhone toujours plus rapide, puissant et intelligent ! '),
(32, 'Iphone 4', 5, '16,32', 199.99, '1,2', 'Brillant, cristallin, lumineux... son écran Retina haute résolution donne le ton... L''iPhone 4 bénéficie en outre d''un appareil photo 5 mégapixels, des appels vidéo FaceTime et d''une batterie longue durée. '),
(33, 'Iphone 3GS', 5, '16,32', 189, '1,2', 'L''iPhone réunit trois appareils en un et offre les fonctions d''un téléphone portable révolutionnaire, d''un iPod à écran panoramique et d''un terminal internet encore jamais vu.');
